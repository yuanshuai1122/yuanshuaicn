...
![输入图片说明](https://aabb-2023.oss-cn-beijing.aliyuncs.com/img_Qohm.png)
...
![image-20221028162443072](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221028162443072.png)
...
**![image-20221101100952650](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221101100952650.png)**

新增后界面如下:

**![image-20221101101555269](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221101101555269.png)**

接着启动定时调度任务

**![image-20221101101737502](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221101101737502.png)**

#### 2.5.2 查看日志

在调度中心的调度日志中就可以看到，任务的执行结果.

![image-20221101101850629](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221101101850629.png)

管控台也可以看到任务的执行信息.

**![image-20221101101958510](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221101101958510.png)**
...
**![image-20221102172115256](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221102172115256.png)**

**通过GLUE IDE在线编辑代码**

**![image-20221102172248883](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221102172248883.png)**
...
**![image-20221101145048598](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221101145048598.png)**
...
![image-20221101150421458](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221101150421458.png)

重新启动,我们可以看到效果是,定时任务会在这两台机器中进行轮询的执行

- 8090端口的控制台日志如下:

  **![image-20221101150852090](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221101150852090.png)**

- 8091端口的控制台日志如下:

  **![image-20221101150938313](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221101150938313.png)**
...
**![image-20221102164333453](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221102164333453.png)**
...
**![image-20221102170055525](https://aabb-2023.oss-cn-beijing.aliyuncs.com/image-20221102170055525.png)**
